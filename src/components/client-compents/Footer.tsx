...
const Footer = () => {
  return (
    <div className="max-h-lg xl:h-[270px] py-4 bg-black rounded-t-2xl ">
      <div className="h-full max-w-6xl flex flex-col items-center lg:flex-row justify-between mx-auto pt-2 gap-6 px-8 ">
        <div className="h-full lg:w-1/3 flex gap-2 items-center lg:items-start flex-col ">
          ...
          <div className="flex flex-col text-white items-center lg:items-start">
            ...
            <a href="mailto:takura.buzz@gmail.com">takura.buzz@gmail.com</a>
          </div>
        </div>
        <div className=" h-full lg:w-1/3 flex flex-col items-start xl:pl-16  gap-2 lg:gap-6 text-center ">
        ...
        <div className="h-full lg:w-1/3 flex flex-col  items-center lg:items-start px-8">
          <div className="flex flex-col items-center lg:items-start gap-1 ">
            <h1 className="text-2xl font-bold text-white">Stay Connected</h1>
            <p className="text-gray-200 text-center lg:text-start ">
