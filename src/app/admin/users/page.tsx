        ...
        <Table className="text-sm text-slate-700">
          <TableHeader className="text-sm text-gray-700 text-left uppercase bg-gray-50">
            <TableRow className="flex gap-32">
              <TableHead className="hidden sm:block px-6 py-2">Name</TableHead>
              <TableHead className="px-6 py-2">Priviledge</TableHead>
              <TableHead className="px-6 py-2">Date Joined</TableHead>
